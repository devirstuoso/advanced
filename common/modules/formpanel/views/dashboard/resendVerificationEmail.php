...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Please fill out your email. A verification email will be sent there.</p>
        ...
        <div class="row">
          <!-- /.col -->
            <div class="form-group col-12">
              <?= Html::submitButton('Send', ['class' => 'btn btn-primary btn-block col-4 float-right', 'name' => 'resend-verification-email-button']) ?>
            </div>
